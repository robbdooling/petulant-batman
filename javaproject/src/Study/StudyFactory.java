...
public class StudyFactory {
	...
	/**
	 * Sets the root that the study factory is looking in
	 * @param newRoot The URL of the new root dir
	 */
	...
	/**
	 * Returns the full names of all studies in the root directory
	 * @return A list of strings which are the full path of all studies found
	...
	/**
	 * Picks a study from the list of generated studies and stores it into the state context
	 * @param Index The index of the study wanted from the list generated by getStudyNames
	 */
